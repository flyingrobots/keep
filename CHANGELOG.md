...
- The canonical `keep.flat-chunks/v1` durable layout specification, typed
  ...
  first-failure plan mutation ledger, and verified storage-profile boundary
  replay law. Production encoding, decoding, admission, ingestion, and
  reconstruction remain assigned to issue #10.
