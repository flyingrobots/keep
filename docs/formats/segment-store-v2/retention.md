...
This page owns retention values, root-generation records, manifests, and heads
for `keep.segment-store/v2`. [Retention publication](retention-publication.md)
owns closure admission and the generation transition.
