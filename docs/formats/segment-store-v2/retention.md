...
implements validated in-memory root, manifest, and head codecs with integrity
before semantic admission. Filesystem publication, transitions, recovery, and
garbage collection remain absent.
