...
`CanonicalStoreMigrationIntent` reproduces typed intent bytes; `CanonicalStoreMigrationReceipt` binds canonical intent, marker, empty states, and complete synchronization; admitted record types verify both.
