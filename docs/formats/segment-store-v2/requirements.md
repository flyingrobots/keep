...
| `KEEP-RETENTION-005` | Closure derivation is deterministic, bounded, cycle-safe, fail-closed, and verifies complete blob reconstruction | exact accounting in `closure.md`; property, corruption, and adversarial catalog tests remain | Specified; implementation planned in #19 |
