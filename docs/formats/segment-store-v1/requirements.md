...
bytes and classify complete caller-supplied segment-stage bytes. They do not
yet claim catalog or head content classification, process-death injection, or
recovery execution.
