...
/// # Errors
///
/// Returns [`RecoveryCatalogStageError`] for oversized input, a complete
/// invalid header, or complete-looking canonical catalog refusal. Known
/// incomplete boundaries are returned as truncation states.
...
/// returned as a truncation state.
