...
pub use adapters::{
    ...
    CanonicalCatalog, CanonicalLayoutRecord, CanonicalPublicationHead, CanonicalRetentionHead,
    CanonicalRetentionManifest, CanonicalRetentionRoot, CatalogAdmissionError,
