...
pub use adapters::{
    ...
    FilesystemRetentionRecoveryError, ObservedRetentionState, PreparedRetentionPublication,
    RetentionAuthorityDirectory, RetentionClosureVerificationError, RetentionCurrentStateRefusal,
    RetentionFixedStage, RetentionHeadDecodeError, RetentionHeadStageAssessment,
    RetentionManifestDecodeError, RetentionManifestEncodeError, RetentionManifestStageAssessment,
    RetentionNamespaceAdmission, RetentionPool, RetentionPoolEntryObservation,
    RetentionPoolObservations, RetentionPublicationError, RetentionPublicationOutcome,
    ...
    RetentionRootEncodeError, RetentionRootStageAssessment, RetentionStageAssessment,
    RetentionStageAssessments, RetentionTransitionDisposition, RetentionTransitionError,
    RetentionTransitionPreflight, RetentionTransitionPreflightError, RetentionTransitionReadiness,
    VerifiedRetentionClosure, assess_head_stage, assess_manifest_stage, assess_root_stage,
