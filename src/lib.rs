...
pub use adapters::{
    ...
    RecoveryPoolNameError, RecoveryRequiredEntry, RecoveryStage, RecoveryStageEvidence,
    ...
    RecoveryStageNamespacePhase, SealedSegment, SegmentDigest, SegmentDurabilityPhase,
    ...
    classify_recovery_names, fingerprint_recovery_stage, initialize_store,
